...
export default function App() {
    ...
    const props = { showUserModal, simulatedTenant, b2bForm, showQuotationCrudModal, handleSaveQuotation, setShowUserModal, handlePrintQuotation, setShowQuotationCrudModal, zatcaConsole, setActiveTab, formatNumber, setIsReportingZatca, loginUsername, suppForm, setSplitCard, token, tableNum, setShowQuotationModal, setShowInvoiceModal, setAssets, showNotification, setShowProductModal, invoices, simulatedDomain, quotationForm, setActiveInvoice, showCustomerModal, setSalesEndDate, setSimulatedDomain, setExpForm, products, posFilter, activeCoupon, currentLanguage, setMobileMenuOpen, activeQuotation, setCouponInput, setReportSubTab, setPaymentMethod, setSimulatedTenant, setOrders, setActiveAssetForQr, loginPassword, updateCartQty, setActiveCoupon, invoiceFormat, setInvoices, userForm, setProdForm, setShowSupplierModal, showProductModal, setShowCustomerModal, showInvoiceModal, user, mobileMenuOpen, salesEndDate, setInvoiceFormat, setZatcaSelectInvoice, couponInput, setProducts, setServiceDuration, hostname, showQuotationModal, setActiveCustomer, setSplitCash, assets, setZatcaConn, setLoginUsername, generateZatcaXml, setInvoiceSource, showAssetQrModal, setQuotations, setShowAssetQrModal, setTheme, custForm, zatcaConn, invoiceSource, setShowAssetModal, setUsersList, setCustForm, zatcaSelectInvoice, showSupplierModal, handleCheckout, assetForm, setSalesSearch, splitCash, showOrderModal, prodForm, handleGenerateZatcaQr, addToCart, employees, orders, cart, orderForm, setPosSearch, splitCard, setExpenses, translations, setToken, setSalesStartDate, setSettings, setOrderForm, expenses, setZatcaConsole, setQuotationForm, setShowExpenseModal, setLoginPassword, handlePrintInvoice, theme, formatCurrency, suppliers, showExpenseModal, posSearch, setPosFilter, isReportingZatca, salesSearch, activeInvoice, customers, quotations, activeAssetForQr, setB2bForm, activeCustomer, removeFromCart, serviceDuration, settings, setActiveQuotation, setAssetForm, authError, setCustomers, showAssetModal, setUser, setSuppForm, setTableNum, activeTab, usersList, salesStartDate, setSuppliers, setEmployees, setShowOrderModal, expForm, setHostname, setUserForm, setCurrentLanguage, setAuthError, setCart, reportSubTab, paymentMethod };
